...
const services = [
  {
    ...
    description: "Complete termite inspection, treatment & long-term prevention for homes and commercial properties."
  },
  {
    emoji: "🪳",
    title: "Cockroach Control",
    description: "Fast-acting gel bait and spray treatment for permanent cockroach elimination."
  },
  {
    emoji: "🦟",
    title: "Mosquito Control",
    description: "Thermal fogging and larvicide treatment to eliminate mosquito breeding grounds."
  },
  {
    emoji: "🐀",
    title: "Rodent Control",
    description: "Safe trapping and baiting programs to keep rats and mice out of your space."
  }
];
const reasons = [
  {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "hero-gradient text-white", "data-ocid": "hero.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 py-20 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full text-sm font-medium bg-white/15 border border-white/25 backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 13 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Licensed & Certified Pest Control" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl font-bold leading-tight mb-4", children: "BPTS Pest Control Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-light opacity-85 mb-10", children: "Trusted Pest Control in Thiruvananthapuram" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 bg-background", "data-ocid": "about.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground mb-5", children: "Pest Control Services in Thiruvananthapuram" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "We provide professional pest control services including termite control, cockroach control, mosquito control, and rodent control across Trivandrum. Safe, effective and affordable solutions for homes and businesses." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 bg-muted", "data-ocid": "services.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground text-center mb-10", children: "Our Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "article",
        {
          className: "service-card",
          "data-ocid": `services.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: service.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground", children: service.title })
            ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 bg-background", "data-ocid": "why.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground text-center mb-10", children: "Why Choose Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: reasons.map((reason, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(reason.Icon, { size: 20 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: reason.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: reason.detail })
            ] })
          ]
        },
        reason.label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 bg-muted", "data-ocid": "contact.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground text-center mb-8", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-8 shadow-card text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, style: { color: "oklch(0.30 0.165 255)" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Thiruvananthapuram, Kerala" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, style: { color: "oklch(0.30 0.165 255)" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91 8838510443" })
          ] })
        ] }),
      ...
      "footer",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mb-1", children: [
            "© ",
            year,
            " BPTS Pest Control | All Rights Reserved"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.60 0.06 255)" }, children: [
            "Built with ❤️ using",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
...
Service({
  "getCard": Func([], [Card], ["query"]),
  "updateCard": Func([Card], [], [])
});
